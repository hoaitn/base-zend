...
<body>
<br>
<center><font size=3 color=black face=Verdana><b>Transaction Search
Results</b></font> <br>
<br>
<table class="api">
...
if (! isset ( $resArray ["L_TRANSACTIONID0"] )) {
	...
	?>
	<tr>
		<td colspan="6" class="thinfield">Results 1 - <?
	echo $count;
	?></td>
	</tr>
	<tr>
	...
	<tr>
		<td><?=$ID?></td>
		<td><a id="TransactionDetailsLink0"
			href="TransactionDetails.php?transactionID=<?=$transactionID?>"><?=$transactionID?></a></td>
