...
<body>
<center>
<form action="TransactionSearchResults.php"><span id=apiheader>TransactionSearch</span>

<table class="api">

	<tr>
		<td class="field">StartDate:</td>
		<td><input type="text" name="startDateStr" maxlength="20" size="10"
			value="<?php
			echo $start_date_str?>" /></td>
		<td>(Required)</td>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
		...
		<td><input type="text" name="endDateStr" maxlength="20" size="10"
			value="<?php
			echo $end_date_str?>" /></td>
	</tr>
	<tr>
		<td></td>
		<td>MM/DD/YYYY</td>
	...
	<tr>
		<td class="field">TransactionID:</td>
