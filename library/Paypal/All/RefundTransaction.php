...
<body>
<br>
<center><font size=2 color=black face=Verdana><b>RefundTransaction</b></font>
<br>
<br>
...
<table class="api">
	<tr>
		<td class="thinfield">Transaction ID:</td>
		<td><input type="text" name="transactionID" value=<?=$transaction_id?>></td>
		<td><b>(Required)</b></td>
	</tr>
	<tr>
		<td class="thinfield">Refund Type:</td>
		<td><select name="refundType">
	...
	<tr>
		...
		<td><input type="text" name="amount" value=<?=$amount?> /> <select
			name="currency">
			<?php
