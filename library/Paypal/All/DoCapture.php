...
<body>
<br>
<center><font size=2 color=black face=Verdana><b>DoCapture</b></font> <br>
<br>

<form action="DoCaptureReceipt.php" method="post">
<table class="api">
	<tr>
		<td class="thinfield">Authorization ID:</td>
		<td><input type="text" name="authorization_id"
			value="<?=$authorization_id?>"></td>
		<td><b>(Required)</b></td>
	</tr>
	<tr>
		<td class="thinfield">Complete Code Type:</td>
		<td><select name="CompleteCodeType">
	...
	<tr>
		...
		<td><input type="text" name="amount" value=<?=$amount?> size="5"
			maxlength="7" /> <select name="currency">
	...
	<tr>
		<td class="thinfield">Invoice ID:</td>
		<td><input type="text" name="invoice_id" /></td>
	</tr>
	<tr>
		<td class="thinfield">Note:</td>
