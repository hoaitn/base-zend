...
<body>
<br>
<center><font size=3 color=black face=Verdana><b>Transaction Details</b></font>
<br>
<br>
...
<table width=400>
	<tr>
		<td>Payer:</td>
		<td><?php
		echo $resArray ['RECEIVEREMAIL']?></td>
	</tr>
	<tr>
		<td>Payer ID:</td>
		<td><?php
		echo $resArray ['PAYERID']?></td>
	</tr>
	<tr>
		<td>First Name:</td>
		<td><?php
		echo $resArray ['FIRSTNAME']?></td>
	</tr>
	<tr>
		<td>Last Name:</td>
		<td><?php
		echo $resArray ['LASTNAME']?></td>
	</tr>
	<tr>
		<td>Transaction ID:</td>
		<td><?php
		echo $resArray ['TRANSACTIONID']?></td>
	</tr>
	<tr>
		<td>Parent Transaction ID (if any):</td>
		<td><?php
		echo $resArray ['PARENTTRANSACTIONID']?></td>
	</tr>
	<tr>
		<td>Gross Amount:</td>
		<td><?php
		echo $resArray ['CURRENCYCODE']?><?php

		echo $resArray ['AMT']?></td>
	</tr>
	<tr>
		<td>Payment Status:</td>
		<td><?php
		echo $resArray ['PAYERSTATUS']?></td>
	</tr>
	<tr>
		<td>Pending Reason:</td>
		<td><?php
		echo $resArray ['PENDINGREASON']?></td>
	</tr>
	<tr>
		<td>ProtectionEligibility:</td>
		<td><?php
		echo $resArray ['PROTECTIONELIGIBILITY']?></td>
	</tr>
</table>
...
?> <br>
<font size=2 color=black face=Verdana> <a id="DoVoidLink"
	href="<?php
	echo $do_void_link?>">Void</a> <a id="DoAuthorization"
	href="<?php
	echo $do_authorization_link?>">Authorization</a> <a
	id="DoCaptureLink" href="<?php
	echo $do_capture_link?>">Capture</a> <a
	id="RefundTransactionLink" href="<?php
	echo $do_refund_link?>">Refund</a>
<a id="BackLink" href="javascript:history.back()">Back</a> <br />
</font></center>
