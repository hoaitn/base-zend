...
<body>
<center>
<form action="ReviewOrder.php" method="POST"><input type=hidden
	name=paymentType value='<?=$paymentType?>'> <span id=apiheader>SetExpressCheckout</span>
...
<table class="api">
	...
	<tr>
		<td colspan="2">
		<center></br>
		You must be logged into <a href="https://developer.paypal.com"
			id="PayPalDeveloperCentralLink" target="_blank">Developer Central<br />
		</a> </br>
		</center>
		</td>
	</tr>
	<tr>
		...
		<td><input type="text" name="paymentAmount" size="5" maxlength="7"
			value="1.00" /> <select name="currencyCodeType">
	...
	<tr>
		...
		<td>Save time. Pay securely without sharing your financial
		information.</td>
	</tr>
</table>
