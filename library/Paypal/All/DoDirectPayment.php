...
<br>
<center><font size=2 color=black face=Verdana><b>DoDirectPayment</b></font>
<br>
<br>
<form method="POST" action="DoDirectPaymentReceipt.php"
	name="DoDirectPaymentForm"><!--Payment type is <?=$paymentType?><br> -->
...
<table width=600>
	...
	<tr>
		...
		Amount:</td>
		<td align=left><br>
		<input type=text size=4 maxlength=7 name=amount value=1.00> USD</td>
	</tr>
	<tr>
		<td />
