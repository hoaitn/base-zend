...
<body>
<br>
<center><font size=2 color=black face=Verdana><b>Do Authorization</b></font>
<br>
<br>

<b>Authorization Response details!</b><br>
<br>
...
<table class="api">
	<tr>
		...
		<td><?php
		echo $resArray ['AUTHORIZATIONID']?></td>
	</tr>
	<tr>
	...
	<tr>
		<td>Gross Amount:</td>
		<td><?php
		echo ($resArray ['CURRENCYCODE'] . $resArray ['AMT'])?></td>
	</tr>
	<tr>
		<td>Payment Status:</td>
		<td><?php
		echo $resArray ['PAYMENTSTATUS']?></td>
	</tr>
	<tr>
